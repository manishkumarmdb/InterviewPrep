...
public class StreamAPI {
  ...
  public static void main(String[] args) {
    ...
    findSecondSmallestElement(listInt);
  ...
  private static void kthHighestSalary(int k, List<Employee> list) {
    System.out.println("Kth highest salary : " + list.stream()
  ...
  private static void sortBySalary(List<Employee> list) {
    System.out.println("Sort by salary : " + list.stream()
        .sorted(new Comparator<Employee>() {
          @Override
          public int compare(Employee o1, Employee o2) {
            return o1.getSalary() - o2.getSalary();
  ...
  private static void findSecondSmallestElement(List<Integer> numbers) {
    System.out.println("Second Smallest Element: " + numbers
        .stream()
        .distinct()
        .sorted()
        .skip(1)
